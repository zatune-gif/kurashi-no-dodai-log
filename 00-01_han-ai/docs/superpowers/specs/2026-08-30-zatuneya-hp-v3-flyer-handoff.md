...
- 掲載内容（優先順）:
  ...
  4. 次の一歩＝QRを2つ（① 無料診断＝当面 https://ai-shindan-zatuneya.netlify.app/（最終URLは独自ドメイン取得時に確定・ユーザー方針2026-08-30。han-ai-diagnosis.netlify.app は使わない）  ② HP https://zatune-gif.github.io/zatuneya-hp/ ）
     ※チラシは印刷物のため、独自ドメイン確定前に増刷するとQRが変わる。入稿タイミングをユーザーに確認する
