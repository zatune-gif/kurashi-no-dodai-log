...
- ④実践編・動画系（5名）要お問い合わせ
- ④実践編・動画系（10名）要お問い合わせ
- ⑤AI活用ルール運用定着編 要お問い合わせ
- ⑥Claude Code・個別（1名）80,000円
...
推薦ルール（必ず守ること）:
- rank 1（type: "standalone"）: 単独サービス（AI実務研修・AI経営改善パッケージ・AI活用伴走・個別業務設計のいずれか1つ）
...
- 推進期（81〜100点）: standalone=AI経営改善パッケージ（360,000円・3か月） or 個別業務設計・Mプラン（制作＋運用サポート）、set=全コースセット（①②③④+⑥グループ・5名）
- スタッフスキル「低め」→ standalone は AI実務研修 ①AI活用知識編 を優先
- スタッフスキル「高い」→ standalone は ⑥Claude Code・個別 or 個別業務設計 を優先
- 規模「51名以上」→ グループ・M系を優先
