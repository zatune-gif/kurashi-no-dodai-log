...
const FALLBACK_RECOMMENDATIONS = {
  ...
  導入期: [
    { rank: 1, type: 'standalone', service: 'AI実務研修 ②実践編・文書系（5名）', price: '要お問い合わせ', reason: '社内文書・SNS投稿・採用広報など、日常的な文書作業をAIで大幅に効率化できます。' },
    { rank: 2, type: 'set', service: '実践セット（②+③+④・5名）', price: '270,000円', reason: '文書・画像・動画の3スキルをまとめて習得できます。社内発信力を一気に強化できます。' }
  ],
  活用期: [
    { rank: 1, type: 'standalone', service: 'AI経営改善パッケージ（360,000円・3か月）', price: '360,000円', reason: '経営課題を起点に、現状診断からKPI設計・体制設計・実装支援まで3か月伴走します。特定業務の改善が一巡した企業の次の一手として最適です。' },
    { rank: 2, type: 'set', service: '入門セット（①+②・10名）', price: '209,000円', reason: '10名規模での研修で、組織全体のAIリテラシーを底上げできます。' }
  ],
  推進期: [
