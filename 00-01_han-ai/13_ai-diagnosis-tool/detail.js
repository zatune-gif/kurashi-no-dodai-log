...
const FALLBACK_RECOMMENDATIONS = {
  ...
  活用期: [
    ...
    { rank: 2, type: 'set', service: '入門セット（①+②・10名）', price: '209,000円', reason: '10名規模での研修で、組織全体のAIリテラシーを底上げできます。人材開発支援助成金など公的支援の対象となり得ます（要件確認が必要）。' }
  ],
  推進期: [
    ...
    { rank: 2, type: 'set', service: '全コースセット（①②③④+⑤グループ・5名）', price: '459,000円', reason: '全5コースで組織全体のAI活用を一気に推進。人材開発支援助成金など公的支援の対象となり得ます（要件確認が必要）。' }
  ]
};
